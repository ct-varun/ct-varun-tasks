                ...
                <a href="index.html" class="navbar-brand">
                    <h2 class="text-white">
                        <?php if ($row['logoimagec'] == "null") {
                            ...
                            echo "<img src='admin/assets/uploads/" . $row['logoimagec'] . "' alt='logo image' height='50px' width='50px'>";
                        }
                        ?>
                    </h2>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        <a href="index.html" class="nav-item nav-link active">
                            <?php echo $row['navhomec']; ?>
                        </a>
                        <a href="about.html" class="nav-item nav-link">
                            <?php echo $row['navaboutc']; ?>
                        </a>
                        <a href="product.html" class="nav-item nav-link">
                            <?php echo $row['navproductsc']; ?>
                        </a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                                <?php echo $row['navpagesc']; ?>
                            </a>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 text-center text-lg-start">
                    <h3 class="fw-light text-white animated slideInRight">
                        <?php echo $row['bannerh3c']; ?>
                    </h3>
                    <h1 class="display-4 text-white animated slideInRight">
                        <?php echo $row['bannerh1beforespanc']; ?> <span class="fw-light text-dark">
                            <?php echo $row['bannerh1spanc']; ?>
                        </span>
                        <?php echo $row['bannerh1afterspanc']; ?>
                    </h1>
                    <p class="text-white mb-4 animated slideInRight">
                        <?php echo $row['bannerpc']; ?>
                    </p>
                    <a href="" class="btn btn-dark py-2 px-4 me-3 animated slideInRight">
                        <?php echo $row['bannerbuttonleftc']; ?>
                    </a>
                    <a href="" class="btn btn-outline-dark py-2 px-4 animated slideInRight">
                        <?php echo $row['bannerbuttonrightc']; ?>
                    </a>
                </div>
                <div class="col-lg-6">
                    <?php echo "<img class='img-fluid animated pulse infinite' src='admin/assets/uploads/" . $row['bannerimagec'] . "'alt='banner image'>"; ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <?php
                    echo "<img class='img-fluid animated pulse infinite'
                     src='admin/assets/uploads/" . $row['aboutimagec'] . "' alt='about image'>";
                    ?>

                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="text-primary mb-4">
                        <?php echo $row['abouth1c']; ?><span class="fw-light text-dark">
                            <?php echo $row['abouth1spanc']; ?>
                        </span>
                    </h1>
                    <p class="mb-4">
                        <?php echo $row['aboutptopc']; ?>
                    </p>
                    <p class="mb-4">
                        <?php echo $row['aboutpbottomc']; ?>
                    </p>
                    <a class="btn btn-primary py-2 px-4" href="">
                        <?php echo $row['aboutbuttonc']; ?>
                    </a>
                </div>
            </div>
        </div>
